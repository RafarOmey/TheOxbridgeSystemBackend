...
describe("post eventRegistration", () => {
    it("POST should insert an eventregistration", () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield supertest_1.default(api).post("/eventRegistrations/signup").send({ "shipId": "3", "teamName": "CoolTeam", "eventCode": "1234", "emailUsername": "duckreas@me.com" });
    ...
    it("ship already registered", () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield supertest_1.default(api).post("/eventRegistrations/signup").send({ "shipId": "4", "teamName": "CoolTeam", "eventCode": "1234", "emailUsername": "duckreas@me.com" });
...
describe("forgot password", () => {
    it("PUT should give the user a new password", () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield supertest_1.default(api).put("/forgotpass").send({ "emailUsername": "duckreas@me.com" });
